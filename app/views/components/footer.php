...
<div class="mt-[-220px] pt-[220px] bg-primary rounded-tl-[500px] rounded-tr-[500px] pb-0">
    ...
    <section class="pt-[204px]">
        <div class="container mx-auto text-center">
            ...
            <div class="pb-[200px] relative inline-block">
                ...
                <img src="<?= url('images/vectors/vector_button_cta1.png') ?>" alt="" class="absolute top-0 right-0 translate-x-full -translate-y-full pointer-events-none w-[14px] h-[14px] md:w-[21px] md:h-[21px]">
                
                <!-- Vector Button CTA 2 - Bottom Left -->
                <img src="<?= url('images/vectors/vector_button_cta2.png') ?>" alt="" class="absolute bottom-0 left-0 -translate-x-full translate-y-full pointer-events-none w-[14px] h-[14px] md:w-[21px] md:h-[21px]" style="bottom: 200px;">
    ...
    <footer class="bg-primary-dark text-white-neutral pt-[80px] relative overflow-hidden">
        ...
        <img src="<?= url('images/vectors/vector_footer1.png') ?>" alt="" class="hidden md:block absolute top-0 right-0 pointer-events-none w-[200px]">
