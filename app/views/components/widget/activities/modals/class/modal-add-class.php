    ...
    function validateForm() {
        ...
        if (allFilled) {
            ...
            submitButtonWrapper.innerHTML = `
                <button type="submit" id="submit-add-class-btn" class="btn-component inline-flex items-center justify-center font-bold transition-all duration-200 py-3 px-6 rounded-xl bg-secondary text-white font-bold text-base hover:opacity-90 active:scale-95 cursor-pointer">
                    Tambah Kelas Baru
                </button>
            `;
        } else {
