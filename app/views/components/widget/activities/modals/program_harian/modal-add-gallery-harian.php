    ...
    function validateForm() {
        ...
        if (allFilled) {
            ...
            submitButtonWrapper.innerHTML = `
                <button type="submit" id="submit-add-gallery-harian-btn" class="btn-component inline-flex items-center justify-center font-bold transition-all duration-200 py-[12px] px-6 rounded-xl bg-primary text-white font-bold text-base h-[52px] hover:opacity-90 active:scale-95 cursor-pointer">
